...
Begin VB.Form frm_lap_jual_perhari1 
   BackColor       =   &H00E0E0E0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Laporan Per Counter Berdasarkan Disc"
   ClientHeight    =   2055
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6375
   ...
   End
End
Attribute VB_Name = "frm_lap_jual_perhari1"
...
Private Sub Cmd_Tampil_Click()
   ...
   tgl2 = msk_tgl2.Text
    ...
    Load frm_lap_counter_disc
    frm_lap_counter_disc.Show
