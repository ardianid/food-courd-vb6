...
Begin VB.Form Frm_Seting_Letak_Foto 
   BackColor       =   &H00E0E0E0&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ucXPButton.XPButton cmd_browse 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Frm_Seting_Letak_Foto.frx":0000
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ucXPButton.XPButton cmd_simpan 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Frm_Seting_Letak_Foto.frx":001C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin ucXPButton.XPButton cmd_keluar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "Frm_Seting_Letak_Foto.frx":0038
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "Frm_Seting_Letak_Foto"
